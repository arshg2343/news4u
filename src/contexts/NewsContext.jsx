...
export const NewsProvider = ({ children }) => {
  ...
  const apikey = "d0fe14ea63624016b032983be72902db"
  ...
  const fetchArticles = async (reset = false) => {
    ...
    try {
      ...
      if (selectedSources.length > 0) {
        url = `https://newsapi.org/v2/top-headlines?page=${currentPage}&pageSize=10&sources=${selectedSources.join(",")}&apiKey=${apikey}`
      }
